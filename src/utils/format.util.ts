...
export const getProgramErrorMessage = (error: unknown) => {
    ...
    return (error as Error).message || "An error occurred while processing the transaction. Please try again later.";
};
