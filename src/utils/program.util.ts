...
export async function claimTokenVesting(
  ...
  console.log(`buyer ${buyer.toBase58()} want claim ${userData.amount.toNumber()} token ${mint.toBase58()} at launch pool ${pool.toBase58()}`);
  console.log('--------------------------------------')
  ...
  console.log("Claim vesting token in tx: ", '\n', getExplorerUrl(tx));
  console.log('********************************')
